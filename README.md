...
功能库文档见上表;非功能库的工程 / 协作文档在此集中登记。完整的文档树(功能库 + 规范 + 学习系列)见 [docs/README.md](./docs/README.md);**后续新增文档请在两处各追加一行**:
...
| [docs/rollup/README.md](./docs/rollup/README.md)                     | Rollup 学习系列(总纲):库打包机制 / 配置实战 / 插件与 JS API / 生态对比 四篇                                                            |
| [docs/qiankun/README.md](./docs/qiankun/README.md)                   | 微前端 qiankun 学习系列(总纲):应用模型 / 资源加载 / JS 沙箱 / 样式隔离 / 通信 / 工程实战 / 生态对比 七篇                               |
| [docs/state-management/README.md](./docs/state-management/README.md) | 前端状态管理双引擎学习系列(总纲):坐标系方法论 / Zustand 内核·React·中间件三篇 / Pinia 内核·进阶两篇 / 双引擎对照 / Server State 共八篇 |
